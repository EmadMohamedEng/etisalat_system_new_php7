...
class UserController extends Controller {
    ...
    public function postSignin(Request $request) {
        ...
        if ($validator->passes()) {
            ...
            // to can login with username or email ............as they are unique
            if (\Auth::attempt(array('email' => $request->input('username'), 'password' => $request->input('password')), $remember)  ||  \Auth::attempt(array('username' => $request->input('username'), 'password' => $request->input('password')), $remember)   ) {
                if (\Auth::check()) {
