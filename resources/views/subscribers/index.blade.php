        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content">
                <div class="toolbar-line ">
                    @if($access['is_add'] ==1)
                    <a href="{{ URL::to('subscribers/update') }}" class="tips btn btn-sm btn-white"
                    ...
                    <a href="{{ URL::to('subscribers/download'.$search) }}" class="tips btn btn-sm btn-white"
                        title="Download not active users">
                        <i class="fa fa-download"></i>&nbsp; Download not active users </a>
                    <a href="{{ URL::to('subscribers/download-active'.$search) }}" class="tips btn btn-sm btn-white"
                        title="Download not active users">
                        <i class="fa fa-download"></i>&nbsp; Download active users </a>
                    @endif


                    <a href="{{ URL::to('randomActiveSubscriber') }}" class="tips btn btn-sm btn-white"
                        title="Random Phone">
                        <i class="fa fa-key"></i>&nbsp; Random Phone </a>
                ...
                {!! Form::open(array('url'=>'subscribers/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' ))
                !!}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ URL::to('subscribers/show/'.$row->id.'?return='.$return)}}"
                                        class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_view') }}"><i
                                            class="fa  fa-search "></i></a>
                                    @endif
                                    @if($access['is_edit'] ==1)
                                    <a href="{{ URL::to('subscribers/update/'.$row->id.'?return='.$return) }}"
...
<script>
    $(document).ready(function () {
        ...
        $('.do-quick-search').click(function () {
            $('#SximoTable').attr('action', '{{ URL::to("subscribers/multisearch")}}');
            $('#SximoTable').submit();
        });
